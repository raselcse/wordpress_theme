<?php 
/*
	Template Name: Home html5 Vedio
...
<?php get_header(); ?>	
	...
	<section class="cd-section">
		<div class="cd-block">
			<div class="home-top-video">
				...
				<video id="video_background_home" preload="auto" autoplay loop="loop" poster="images/trans.png"> 
					<source src="<?php echo ot_get_option('home_video')?>" type="video/webm"> 
 ...
 <!-- .cd-section -->
	...
	<script type="text/javascript" src="<?php bloginfo('stylesheet_directory'); ?>/js/custom-home4.js"></script>
	<?php get_footer();?>