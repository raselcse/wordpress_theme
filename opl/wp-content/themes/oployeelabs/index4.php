					...
					<ul class="slimmenu">
						<li>
							...
							<ul class="submenu-back">
								...
								<li>
									<a class="active-menu animsition-link" href="index4.html">html5 video</a>
								</li>
								<li>
		...
		<div class="cd-block">
			<div class="home-top-video">
				...
				<video id="video_background_home" preload="auto" autoplay loop="loop" poster="images/trans.png"> 
					...
					<source src="videos/video-home.ogg" type="video/ogg"> 
				</video>	
...
<script type="text/javascript" src="js/custom-home4.js"></script>  	  
<!-- End Document
================================================== -->
</body>
</html>