<?php 
/*
	Template Name: Portfolio No Space
*/
?>
<?php get_header();?>
						...
						?>
						   <a href="<?php the_permalink()?>" class="animsition-link">
								<div class="portfolio-box-1 <?php echo $terms_slug_str;?>">
									<div class="mask-1 no-border-work"></div>
	...
	<script type="text/javascript" src="<?php bloginfo('stylesheet_directory'); ?>/js/custom-work4.js"></script>
