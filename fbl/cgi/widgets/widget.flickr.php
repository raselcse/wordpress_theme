...
class flickr_photos extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		<?php if($no_of_photos>10&&$flickr_display=='random'){ ?>
		<script type="text/javascript" src="http://www.flickr.com/badge_code_v2.gne?count=<?php echo ($no_of_photos-10); ?>&amp;display=<?php echo $flickr_display; ?>&amp;size=s&amp;layout=x&amp;source=user&amp;user=<?php echo $flickr_id; ?>"></script>   
		<?php } ?>	
		</div>
	<?php 
		echo $after_widget;
	...
	function form( $instance ) {
		$defaults = array( 'flickr_title' =>__( 'Flickr' , 'devn'), 'no_of_photos' => '6' , 'flickr_display' => 'latest','flickr_id'=>'' );
