<?php
class DS_Options_typography extends DS_Options{	
	...
	*/
	function render(){
		...
		DS_Options::_fonts($this->args['opt_name'].'['.$this->field['id'].'][font]', $this->value['font']);
		
		?>
		
			<select name="<?php echo $this->args['opt_name'].'['.$this->field['id'].'][size]'; ?>" style="width:80px;">
				<option value=""></option>
				<?php
			...
			<select name="<?php echo $this->args['opt_name'].'['.$this->field['id'].'][weight]'; ?>" style="width:80px;">
			...
			<select name="<?php echo $this->args['opt_name'].'['.$this->field['id'].'][style]'; ?>" style="width:90px;">
